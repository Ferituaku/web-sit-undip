...
<div class="d-flex">
    <!-- Sidebar -->
    <aside class="sidebar vh-100 position-fixed" style="width: var(--sidebar-width);">
    ...
    <main class="flex-grow-1" style="margin-left: 260px;">
        <!-- Header -->
        <header class="bg-white p-3 border-bottom shadow-sm fixed-top" style="margin-left: 264.4px">
